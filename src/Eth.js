...
const Eth = () => {
  const ethe = async () => {
    ...
    const caddress = '0x6703Bb660C4851FF1Ad4446FEA64B31Ab0918052';
    ...
    try {
      ...
      // Call your contract function (e.g., rewardClient)
       const transaction=await myContract.rewardClient({ gasLimit: 20000000 });
...
await provider.waitForTransaction(transaction.hash)
  ...
  return (
    <div>
      Eth
      <button onClick={ethe}>Reward</button>
    </div>
  );
};
